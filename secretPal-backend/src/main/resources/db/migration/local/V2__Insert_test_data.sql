...
(id, description, is_active) VALUES
  (1, 'Si el Pino A le regala a el Pino B, el Pino B no le puede regalar a el Pino A.', TRUE);

INSERT INTO not_too_close_birthdays_rule
(id, description, is_active) VALUES
  (1, 'Esta permitido regalar aunque el cumpleaños del pino también esté cerca.', TRUE);